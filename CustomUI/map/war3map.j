...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'Hpal', - 522.8, - 737.9, 337.983)
endfunction
//===========================================================================
...
call func_bind_trigger_name(function Trig____________________002Actions , "未命名触发器 002")
...
call ExecuteFunc("jasshelper__initstructs433325911")
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(1, - 576.0, - 1728.0)
    // Player setup
...
function jasshelper__initstructs433325911 takes nothing returns nothing
